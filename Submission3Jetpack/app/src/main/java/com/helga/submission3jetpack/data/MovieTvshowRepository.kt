...
class MovieTvshowRepository private constructor(
    ...
    companion object {
        ...
        fun getInstance(remoteData: RemoteDataSource, localData: LocalDataSource, appExecutors: AppExecutors): MovieTvshowRepository =
            instance ?: synchronized(this) {
                instance ?: MovieTvshowRepository(remoteData, localData, appExecutors).apply { instance = this }
            }
    }
